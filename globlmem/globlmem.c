...
static ssize_t globalmem_read(struct file *filp, char __user *buf, size_t size, loff_t *f_pos)
{
...
static ssize_t globalmem_write(struct file *filp, const char __user *buf, size_t size, loff_t *f_pos)
{
	unsigned long p = *f_pos;
	unsigned int count = size;
	int ret = 0;
